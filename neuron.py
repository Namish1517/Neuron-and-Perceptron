...
# Function to get user input for weights and bias
...
# Function to reset weights and bias randomly
...
# Block 2: Weighted sum calculation
...
# Run the weighted sum for all inputs
...
# Block 3: Activation function (step function)
...
# Apply activation function to weighted sums and print outputs
